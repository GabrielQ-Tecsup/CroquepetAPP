...
class AppConstants {
  ...
  static const String MAP_API_KEY="AIzaSyCgg1RMSkGG6JOXjOs3u4XSGGbYAqmR8qs";
  ...
  static const String BASE_URL = 'https://croquepetprueba.up.railway.app';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'Español', countryCode: 'ES', languageCode: 'es'),
  ];
}